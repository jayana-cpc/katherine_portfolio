...
import { LayoutGrid } from "./image-grid-base";
...
const SkeletonOne = () => {
  return (
    <div
      ...
      style={{ backgroundImage: "url(https://i.imgur.com/QqId3sP.jpeg)" }}
    >
...
const SkeletonTwo = () => {
  return (
    <div
      className="relative w-full h-full bg-cover bg-center"
      style={{ backgroundImage: "url(https://i.imgur.com/NtzGlbJ.jpeg)" }}
    >
      <div className="relative z-10 p-4 md:p-10 bg-black bg-opacity-50 h-full flex flex-col justify-end rounded-lg">
        <p className="font-bold md:text-4xl text-xl text-white">
...
const SkeletonThree = () => {
  return (
    <div
      className="relative w-full h-full bg-cover bg-center"
      style={{ backgroundImage: "url(https://i.imgur.com/eia22gi.jpeg)" }}
    >
      <div className="relative z-10 p-4 md:p-10 bg-black bg-opacity-50 h-full flex flex-col justify-end rounded-lg">
        <p className="font-bold md:text-4xl text-xl text-white">
          Greens all over
...
const SkeletonFour = () => {
  return (
    <div
      className="relative w-full h-full bg-cover bg-center"
      style={{ backgroundImage: "url(https://i.imgur.com/9eZASOS.jpeg)" }}
    >
      <div className="relative z-10 p-4 md:p-10 bg-black bg-opacity-50 h-full flex flex-col justify-end rounded-lg">
        <p className="font-bold md:text-4xl text-xl text-white">
          Rivers are serene
