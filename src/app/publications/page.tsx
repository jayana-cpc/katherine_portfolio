...
import { ExpandableCardDemo } from "@/components/Publications/publications-table";
        ...
        <Container fluid style={{ position: "relative", zIndex: 1 }}>
          <Grid>
            <Grid.Col span={{ base: 12, xs: 12 }}>
              <h1 className="text-8xl ml-2 font-bold text-white hover:glow">
                Publications
              </h1>
            </Grid.Col>
            <Grid.Col span={{ base: 12, xs: 12 }}>
            ...
            <Grid.Col>
              <Grid style={{ maxWidth: "100px" }}>
                <Grid.Col>
                  <a
                    href="https://www.linkedin.com/in/katherine-lee-aa4010256/"
                    target="_blank"
                ...
                <Grid.Col>
                  <a
                    href="https://orcid.org/0009-0009-8466-3576"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <div className="ml-2 overflow-hidden transform transition duration-200 hover:translate-x-1 hover:text-white flex items-center">
            ...
            <Grid.Col style={{ height: "50px" }}></Grid.Col>
            <Grid.Col span={{ base: 12, xs: 12 }}>
              <Buttons />
            </Grid.Col>
          </Grid>
